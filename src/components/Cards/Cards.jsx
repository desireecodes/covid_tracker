...
const Cards = ({ data: {confirmed, recovered, deaths, lastUpdate} }) => {
        ...
        <div className={styles.container}>
            <Grid container spacing={3} justify="center">
                <Grid item component={Card} xs={12} md={3} className={cx(styles.card, styles.infected)}>
                    <CardContent>
                        <Typography color="white" variant="h6" gutterBottom>Infected</Typography>
    ...
    <Typography colr="textSecondary">{new Date(lastUpdate).toDateString()}</Typography>
                ...
                <Grid item component={Card}xs={12} md={3} className={cx(styles.card, styles.recovered)}>
                    <CardContent>
                        <Typography color="white" variant="h6" gutterBottom>Recovered</Typography>
                        <Typography variant="h5">
                ...
                <Grid item component={Card}xs={12} md={3} className={cx(styles.card, styles.deaths)}>
                    <CardContent>
                        <Typography color="white" variant="h6" gutterBottom>Deaths</Typography>
                        <Typography variant="h5">
